...
import { UserPlus, Mail, Lock, User, AlertCircle, Eye, EyeOff, Loader2 } from 'lucide-react'
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Dライフに参加して、仲間とつながりましょう</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-gray-500">
          登録することで、
          <Link href="/terms" className="text-rose-500 hover:underline">利用規約</Link>
          および
          <Link href="/privacy" className="text-rose-500 hover:underline">プライバシーポリシー</Link>
          に同意したものとみなされます。
        </p>
      </div>
    </div>
