...
import { CheckCircle, XCircle, Flag, AlertTriangle, HelpCircle, ArrowLeft } from 'lucide-react'
          ...
          <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                <Link href="/faq" className="text-rose-500 hover:underline">FAQ</Link>
                または
                <Link href="/contact" className="text-rose-500 hover:underline ml-1">お問い合わせ</Link>
                へ
              </p>
            </div>
          </div>
