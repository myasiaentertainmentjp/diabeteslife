...
const features = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=600&q=75&fit=crop',
  },
  {
    icon: BarChart2,
    title: '健康記録・グラフ',
    ...
    image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=600&q=75&fit=crop',
  },
  {
    icon: BookOpen,
    title: '記事・情報',
    ...
    image: 'https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?w=600&q=75&fit=crop',
  },
]
...
const voices = [
  {
    ...
    name: '40代・2型糖尿病・女性',
    avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=80&q=75&fit=crop&crop=face',
  },
  {
    text: 'HbA1cの記録をつけ始めてから、数値への意識が変わりました。グラフが励みになっています。',
    name: '50代・2型糖尿病・男性',
    avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&q=75&fit=crop&crop=face',
  },
  {
    text: '家族として参加しています。患者さんの本音が聞けて、接し方のヒントをたくさんもらえました。',
    name: '30代・家族としてサポート',
    avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&q=75&fit=crop&crop=face',
  },
]
      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="mb-12">
          <div className="relative rounded-2xl overflow-hidden mb-6">
            <Image
              src="https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=900&q=75&fit=crop"
              alt="コミュニティのイメージ"
              width={900}
              height={400}
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-gray-900/60 to-transparent flex items-end p-6">
              <h2 className="text-white text-xl font-bold">Dライフが生まれた背景</h2>
            </div>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            {features.map((f) => {
              const Icon = f.icon
              return (
                <div key={f.title} className={"bg-white border rounded-2xl overflow-hidden shadow-sm " + f.border}>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: Users, color: 'text-purple-500', bg: 'bg-purple-50', title: 'コミュニティ', desc: '患者・家族・サポーター多様なメンバーが集まります' },
                { icon: Shield, color: 'text-orange-500', bg: 'bg-orange-50', title: '安心・安全', desc: 'モデレーションで誰もが安心して話せる環境を維持' },
              ].map((f) => {
                const Icon = f.icon
                return (
                  <div key={f.title} className="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm">
                    <div className={"w-9 h-9 rounded-xl flex items-center justify-center mb-3 " + f.bg}>
