...
export function ThreadDetail() {
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center py-12">
          <p className="text-gray-600 mb-4">トピックが見つかりませんでした</p>
          <button
            onClick={() => navigate(-1)}
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {/* Floating comment button - bottom right */}
      {!mobileCommentOpen && (
        <button
          onClick={() => {
            setMobileCommentOpen(true)
          ...
          {user ? (
            <form onSubmit={(e) => {
              ...
              <div className="flex items-center justify-between mt-3">
                <div className="flex items-center gap-3">
                  ...
                  <label htmlFor="comment-image-input" className="flex items-center gap-1 px-3 py-1.5 text-gray-500 hover:text-rose-500 rounded-lg cursor-pointer text-sm">
                    <Image size={18} />
                    <span>画像</span>
                  </label>
            ...
            <div className="p-6 text-center">
              ...
              <button
                ...
                className="w-full py-3 bg-rose-500 text-white rounded-lg font-medium text-sm hover:bg-rose-600 transition-colors"
              >
                ログインしてコメントする
              </button>
            </div>
