#!/usr/bin/env python3
"""Insert 52 comments for thread No.54: お餅は食べる？食べない？"""
...
THREAD_ID = "7a1174f2-7325-45d9-b22e-9e3ee3e6dd6e"
...
COMMENTS = [
    (2, None, "お餅、食べますか？食べませんか？悩んでます", "2025-12-15 19:08"),
    (3, None, "1個だけ食べます。お正月だし", "2025-12-15 19:44"),
    (4, None, "完全に我慢してます。血糖値爆上がりするから", "2025-12-15 20:21"),
    (5, 3, "1個で我慢できるのすごい", "2025-12-16 08:14"),
    (6, None, "診断されたばかりでお餅食べていいかわからない", "2025-12-16 12:21"),
    (7, 6, "量を控えれば大丈夫ですよ。切り餅1個で糖質25gくらい", "2025-12-16 12:57"),
    (8, None, "低糖質餅を通販で買いました", "2025-12-16 19:13"),
    (9, None, "そんなのあるんですか？", "2025-12-16 19:49"),
    (10, 8, "どこで買えますか？", "2025-12-16 20:26"),
    (11, 10, "Amazonで「低糖質 餅」で検索すると出てきますよ", "2025-12-17 08:11"),
    (12, None, "お餅2個で糖質50g。ご飯茶碗1杯と同じくらい", "2025-12-17 12:17"),
    (13, None, "そう考えると結構多いですよね", "2025-12-17 12:53"),
    (14, 12, "だから1個までにしてます", "2025-12-17 19:08"),
    (15, None, "診断されて3年目、お餅は諦めてます", "2025-12-18 12:17"),
    (16, 15, "お雑煮の具だけ食べてますか？", "2025-12-18 12:53"),
    (17, 16, "そうです。汁と具だけで満足してます", "2025-12-18 19:08"),
    (18, None, "食べた後ウォーキングすれば大丈夫かな", "2025-12-18 19:44"),
    (19, None, "運動で多少は相殺できるかも", "2025-12-18 20:21"),
    (20, 18, "食後の運動は血糖値下げる効果ありますよね", "2025-12-19 08:14"),
    (21, None, "10年以上糖尿病で、お餅は年に1回だけ食べてます", "2025-12-19 12:17"),
    (22, 21, "元日だけって決めてるんですね", "2025-12-19 12:53"),
    (23, None, "きな粉餅が好きだけど、きな粉にも砂糖入ってる", "2025-12-19 19:08"),
    (24, None, "ラカントできな粉作ればいいかも", "2025-12-19 19:44"),
    (25, 23, "磯辺焼きなら海苔と醤油だけでいけますよ", "2025-12-19 20:21"),
    (26, None, "お餅食べた後のリブレの数値が怖い", "2025-12-20 12:17"),
    (27, None, "200超えることありますよね", "2025-12-20 12:53"),
    (28, 26, "私は1個で180くらいまで上がりました", "2025-12-20 19:08"),
    (29, None, "家族は普通にお餅食べてるから誘惑が…", "2025-12-22 12:17"),
    (30, None, "わかります。匂いだけでも美味しそう", "2025-12-22 12:53"),
    (31, 29, "1個だけ一緒に食べるのもありですよ", "2025-12-22 19:08"),
    (32, None, "元日に備えてお餅1個だけ買った", "2025-12-28 14:08"),
    (33, 32, "潔いですね！", "2025-12-28 14:44"),
    (34, None, "あけおめ！今日お餅食べます", "2026-01-01 08:14"),
    (35, None, "あけおめ！私も1個だけ食べる予定", "2026-01-01 08:51"),
    (36, 34, "楽しんでください！", "2026-01-01 09:28"),
    (37, None, "お雑煮食べました！お餅1個で満足", "2026-01-01 10:14"),
    (38, None, "私も食べた。美味しかった", "2026-01-01 10:51"),
    (39, 37, "血糖値どうでしたか？", "2026-01-01 11:28"),
    (40, 39, "食後1時間で170。許容範囲かな", "2026-01-01 12:17"),
    (41, None, "今年のお餅は今日で終わり！", "2026-01-01 19:08"),
    (42, 41, "潔くていいですね", "2026-01-01 19:44"),
    (43, None, "結局2個食べてしまった…", "2026-01-02 10:14"),
    (44, None, "お正月だから許してあげて", "2026-01-02 10:51"),
    (45, 43, "今日から気をつければ大丈夫ですよ", "2026-01-02 14:08"),
    (46, None, "お餅問題、無事乗り切った", "2026-01-03 12:17"),
    (47, None, "お疲れ様でした！", "2026-01-03 12:53"),
    (48, 46, "私も今年は控えめにできた", "2026-01-03 19:08"),
    (49, None, "このスレのおかげで意識できた", "2026-01-04 19:08"),
    (50, 49, "情報共有できてよかったです", "2026-01-04 19:44"),
    (51, None, "来年のお餅対策の参考にします", "2026-01-05 19:08"),
    (52, None, "また来年のお正月に！", "2026-01-06 19:08"),
    (53, 52, "来年もよろしくお願いします", "2026-01-06 19:44"),
]
...
def main():
    print(f"Processing {len(COMMENTS)} comments for thread No.54")
