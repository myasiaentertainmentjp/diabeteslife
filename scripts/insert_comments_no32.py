#!/usr/bin/env python3
"""Insert 59 comments for thread No.32: 糖尿病と睡眠の関係"""
...
THREAD_ID = "8dfd9246-5500-4d16-996f-b19ab1f39787"
...
COMMENTS = [
    (2, None, "睡眠不足だと血糖値上がりませんか？", "2025-12-16 19:00"),
    (3, None, "私も寝不足の翌朝は確実に高い", "2025-12-16 19:45"),
    (4, 2, "コルチゾールが増えて血糖値上がるらしいですね", "2025-12-16 20:30"),
    (5, None, "何時間睡眠が理想なんだろう", "2025-12-17 12:00"),
    (6, None, "7〜8時間がベストって聞いた", "2025-12-17 12:45"),
    (7, 5, "私は7時間でちょうどいい感じです", "2025-12-17 19:00"),
    (8, None, "診断されたばかりで睡眠リズム乱れがち", "2025-12-17 19:45"),
    (9, None, "夜中にトイレで目が覚める。血糖値高いせいかな", "2025-12-17 20:30"),
    (10, 9, "高血糖だと喉乾いて水分取るからトイレ近くなりますよね", "2025-12-18 08:00"),
    (11, None, "睡眠時無呼吸症候群と糖尿病って関係あるんですか", "2025-12-18 12:00"),
    (12, None, "SASの検査受けたら軽度って言われた", "2025-12-18 12:45"),
    (13, 11, "関係あるみたいですよ。SAS治療したら血糖値も改善した人いる", "2025-12-18 19:00"),
    (14, None, "寝る前のスマホやめたら睡眠の質上がった", "2025-12-18 19:45"),
    (15, None, "昼寝すると夜寝れなくなる", "2025-12-19 12:00"),
    (16, 15, "昼寝は20分以内がいいらしいですよ", "2025-12-19 13:00"),
    (17, None, "夜勤があるから睡眠リズムがバラバラ", "2025-12-19 19:00"),
    (18, None, "CPAP使ってる人いますか？", "2025-12-19 19:45"),
    (19, 18, "使ってます。慣れるまで大変だったけど今は手放せない", "2025-12-19 20:30"),
    (20, None, "寝すぎても血糖値上がる気がする", "2025-12-20 12:00"),
    (21, None, "10年以上糖尿病だけど、睡眠の大切さ最近やっとわかった", "2025-12-20 14:00"),
    (22, 20, "寝すぎると生活リズム乱れますよね", "2025-12-20 19:00"),
    (23, None, "入眠に時間かかる人いますか？", "2025-12-20 19:45"),
    (24, None, "ベッドに入っても1時間くらい寝れないことある", "2025-12-20 20:30"),
    (25, 23, "寝る前のストレッチで少し楽になりました", "2025-12-21 08:00"),
    (26, None, "リブレで見ると睡眠中も血糖値動いてる", "2025-12-21 12:00"),
    (27, None, "朝方に血糖値上がるパターン。暁現象ってやつ", "2025-12-21 19:00"),
    (28, 26, "夜中のグラフ見るの面白いですよね", "2025-12-21 19:45"),
    (29, None, "カフェイン控えたら睡眠の質上がった", "2025-12-22 12:00"),
    (30, None, "年末年始、夜更かししそうで怖い", "2025-12-22 19:00"),
    (31, 30, "生活リズム乱れると血糖値に響きますよね", "2025-12-22 19:45"),
    (32, None, "睡眠アプリ使ってる人いますか？", "2025-12-23 12:00"),
    (33, None, "Apple Watchで睡眠計測してます", "2025-12-23 13:00"),
    (34, 32, "Sleep Cycleってアプリ使ってます。起きやすいタイミングで起こしてくれる", "2025-12-23 19:00"),
    (35, None, "寝酒は睡眠の質下がるからやめた", "2025-12-23 19:45"),
    (36, None, "睡眠負債って怖いですよね", "2025-12-24 14:00"),
    (37, None, "クリスマス夜更かしした。明日の血糖値怖い", "2025-12-25 00:30"),
    (38, 37, "私も…今日は早く寝ます", "2025-12-25 19:00"),
    (39, None, "枕変えたら睡眠の質上がった気がする", "2025-12-26 12:00"),
    (40, None, "診断されて3年目、睡眠リズム整えたらHbA1c下がった", "2025-12-26 19:00"),
    (41, 40, "やっぱり睡眠大事なんですね", "2025-12-26 19:45"),
    (42, None, "年末年始、起きる時間だけは固定しようと思う", "2025-12-27 14:00"),
    (43, None, "紅白見て夜更かし確定…", "2025-12-31 22:00"),
    (44, None, "あけおめ！昨夜は夜更かしした", "2026-01-01 10:00"),
    (45, 44, "私も。今日は早く寝ます", "2026-01-01 11:00"),
    (46, None, "正月休みで寝すぎた。生活リズム戻さないと", "2026-01-03 14:00"),
    (47, None, "仕事始まったら睡眠リズム戻るかな", "2026-01-03 19:00"),
    (48, 46, "私も。明日から頑張って早起きします", "2026-01-03 19:45"),
    (49, None, "質の良い睡眠のために何してますか？", "2026-01-04 12:00"),
    (50, None, "寝る2時間前には食事終わらせてます", "2026-01-04 13:00"),
    (51, 49, "寝室の温度と湿度に気をつけてます", "2026-01-04 19:00"),
    (52, None, "このスレ見て睡眠の大切さ再認識した", "2026-01-05 12:00"),
    (53, None, "睡眠も血糖管理の一部だと思うようになった", "2026-01-05 19:00"),
    (54, 52, "食事・運動・睡眠、全部大事ですよね", "2026-01-05 19:45"),
    (55, None, "不眠で悩んでる人は主治医に相談した方がいいかも", "2026-01-06 12:00"),
    (56, None, "睡眠薬使ってる人いますか？", "2026-01-06 19:00"),
    (57, 56, "一時期使ってたけど今は自然に寝れてます", "2026-01-06 19:45"),
    (58, None, "また睡眠の工夫あったら教えてください", "2026-01-07 12:00"),
    (59, 58, "お互い情報共有しましょう", "2026-01-07 12:45"),
    (60, None, "睡眠大事にして血糖管理頑張ろう", "2026-01-07 19:00"),
]
...
def main():
    print(f"Processing {len(COMMENTS)} comments for thread No.32")
