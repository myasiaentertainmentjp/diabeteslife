#!/usr/bin/env python3
"""Insert 61 comments for thread No.84: 温泉旅行と糖尿病"""
...
THREAD_ID = "ee325b97-0a13-4aca-bbc4-839f2d922eb9"
...
COMMENTS = [
    (2, None, "温泉旅行行きたいけど糖尿病だと気をつけることある？", "2025-12-20 19:30"),
    (3, None, "旅館の食事が豪華すぎて血糖値心配", "2025-12-20 20:15"),
    (4, None, "診断されたばかりで温泉旅行を諦めようか迷ってる", "2025-12-20 21:00"),
    (5, 4, "諦めなくていいですよ。工夫次第で楽しめます", "2025-12-20 21:45"),
    (6, None, "10年以上糖尿病だけど年に2〜3回は温泉行ってる", "2025-12-21 10:30"),
    (7, 6, "いいですね！どんな対策してますか？", "2025-12-21 11:15"),
    (8, 7, "ご飯は少なめにしてもらう。事前に連絡すると対応してくれる宿もある", "2025-12-21 12:00"),
    (9, None, "長風呂すると低血糖になりそうで怖い", "2025-12-21 15:45"),
    (10, 9, "入浴前に血糖値チェックするといいですよ", "2025-12-21 16:30"),
    (11, None, "3年目だけど温泉大好き。リフレッシュになる", "2025-12-22 11:30"),
    (12, 11, "温泉いいですよね。ストレス解消にもなる", "2025-12-22 12:15"),
    (13, None, "リブレつけたまま温泉入れる？", "2025-12-22 18:45"),
    (14, 13, "入れますよ。防水だから大丈夫", "2025-12-22 19:30"),
    (15, 13, "腕につけてると目立つから気になる人はいるかも", "2025-12-22 20:15"),
    (16, None, "インスリン持っていくとき保冷バッグ必要？", "2025-12-23 10:30"),
    (17, 16, "開封済みなら常温でOK。未開封は冷蔵庫借りるといい", "2025-12-23 11:15"),
    (18, 16, "宿に頼めば冷蔵庫で預かってくれますよ", "2025-12-23 12:00"),
    (19, None, "朝食バイキングが危険。ついつい食べすぎる", "2025-12-23 15:45"),
    (20, 19, "わかる。あれもこれも食べたくなる", "2025-12-23 16:30"),
    (21, None, "夕食の量が多すぎて全部食べられない", "2025-12-23 20:15"),
    (22, 21, "無理して食べなくていいと思います", "2025-12-23 21:00"),
    (23, None, "糖尿病食プランがある宿ってあるのかな", "2025-12-24 11:30"),
    (24, 23, "探せばありますよ。事前に相談すると対応してくれる宿も", "2025-12-24 12:15"),
    (25, None, "露天風呂最高だけど長湯注意", "2025-12-24 19:20"),
    (26, 25, "気持ち良くてつい長く入っちゃいますよね", "2025-12-24 20:00"),
    (27, None, "温泉の効能で血糖値下がったりしないかな笑", "2025-12-25 14:30"),
    (28, 27, "リラックス効果でストレス減れば間接的にいいかも", "2025-12-25 15:15"),
    (29, None, "旅行中の薬の管理どうしてますか", "2025-12-25 20:30"),
    (30, 29, "ピルケースに入れて持ち歩いてます", "2025-12-25 21:15"),
    (31, 29, "飲み忘れないようにアラームかけてる", "2025-12-25 22:00"),
    (32, None, "年末年始に温泉旅行計画中", "2025-12-26 11:45"),
    (33, 32, "いいですね！どこに行くんですか？", "2025-12-26 12:30"),
    (34, 33, "草津温泉です。楽しみ", "2025-12-26 13:15"),
    (35, None, "温泉街の食べ歩きも誘惑多い", "2025-12-26 19:20"),
    (36, 35, "温泉まんじゅうとか危険ですよね", "2025-12-26 20:00"),
    (37, None, "ヒートショックに気をつけて入浴してる", "2025-12-27 10:30"),
    (38, 37, "脱衣所と浴室の温度差怖いですよね", "2025-12-27 11:15"),
    (39, None, "温泉旅行行ってきた！最高だった", "2026-01-05 19:30"),
    (40, 39, "いいなー！血糖値どうでした？", "2026-01-05 20:15"),
    (41, 40, "食事気をつけたから思ったより上がらなかった", "2026-01-05 21:00"),
    (42, None, "温泉でリフレッシュできた", "2026-01-06 18:30"),
    (43, None, "また行きたいな", "2026-01-06 20:00"),
    (44, None, "このスレ参考になった", "2026-01-07 19:15"),
    (45, None, "温泉旅行、諦めなくていいんだね", "2026-01-07 20:30"),
    (46, 45, "工夫次第で楽しめますよ", "2026-01-07 21:15"),
    (47, None, "糖尿病でも旅行楽しもう", "2026-01-08 18:30"),
    (48, None, "次はどこの温泉行こうかな", "2026-01-08 20:00"),
    (49, None, "箱根もいいですよね", "2026-01-08 20:45"),
    (50, None, "別府行ってみたい", "2026-01-09 18:30"),
    (51, 50, "別府いいですね。地獄めぐりも楽しそう", "2026-01-09 19:15"),
    (52, None, "温泉旅行の計画立てるの楽しい", "2026-01-09 20:30"),
    (53, None, "みんなの温泉情報参考になる", "2026-01-10 18:30"),
    (54, None, "このスレありがとう", "2026-01-10 19:45"),
    (55, None, "また旅行レポ聞かせてください", "2026-01-10 20:30"),
    (56, None, "温泉仲間がいて嬉しい", "2026-01-10 21:15"),
    (57, None, "来年もたくさん温泉行こう", "2026-01-11 18:30"),
    (58, None, "健康に気をつけながら楽しもう", "2026-01-11 19:45"),
    (59, None, "このスレ最高でした", "2026-01-11 20:30"),
    (60, None, "ありがとうございました！", "2026-01-11 21:15"),
    (61, None, "また情報交換しましょう", "2026-01-12 18:45"),
    (62, None, "温泉旅行最高！", "2026-01-12 19:30"),
]
...
def main():
    print(f"Processing {len(COMMENTS)} comments for thread No.84")
