#!/usr/bin/env python3
"""Insert 60 comments for thread No.26: 夜中に血糖値が上がる人"""
...
THREAD_ID = "c728448e-9685-4ea5-a74f-a8a4709d1635"
...
COMMENTS = [
    (2, None, "リブレで見ると夜中2時頃から血糖値上がってる。なんで？", "2025-12-16 07:30"),
    (3, 2, "暁現象かもしれないですね。ホルモンの影響らしいです", "2025-12-16 08:15"),
    (4, 2, "私も同じです！夜中何も食べてないのに上がる", "2025-12-16 12:00"),
    (5, None, "夕食後は下がるのに、夜中から朝にかけて上がるパターン", "2025-12-16 19:00"),
    (6, 5, "完全に暁現象ですね。私も同じでした", "2025-12-16 19:30"),
    (7, None, "夜中に低血糖になってその反動で上がることもあるって聞いた", "2025-12-16 20:30"),
    (8, 7, "ソモジー効果ですね。リブレで夜中のグラフ確認するとわかる", "2025-12-17 08:00"),
    (9, 8, "ソモジー効果と暁現象ってどう見分けるんですか？", "2025-12-17 10:00"),
    (10, 9, "夜中に70以下まで下がってたらソモジー、下がってなければ暁現象", "2025-12-17 12:00"),
    (11, None, "診断されたばかりで夜中のグラフ見方がわからない", "2025-12-17 19:00"),
    (12, 11, "リブレのアプリで「AGPレポート」見ると傾向がわかりますよ", "2025-12-17 19:30"),
    (13, 11, "最初は先生に一緒にグラフ見てもらうといいかも", "2025-12-17 20:30"),
    (14, None, "夜中の上昇、対策してますか？", "2025-12-18 12:00"),
    (15, 14, "眠前にメトホルミン追加してもらいました", "2025-12-18 12:30"),
    (16, 14, "夕食の糖質減らしたら少しマシになった", "2025-12-18 19:00"),
    (17, 15, "効果ありましたか？", "2025-12-18 19:30"),
    (18, 17, "朝の血糖値が130→110くらいに下がりました", "2025-12-18 20:30"),
    (19, None, "1型で持効型インスリンの量調整してる人いますか？", "2025-12-19 08:00"),
    (20, 19, "トレシーバ使ってます。夜中の上昇見て2単位増やしました", "2025-12-19 10:00"),
    (21, 19, "ランタスですが、打つ時間を調整したら良くなりました", "2025-12-19 12:00"),
    (22, 20, "自分で調整しましたか？先生に相談してからですか？", "2025-12-19 14:00"),
    (23, 22, "先生に相談して、2単位ずつ様子見ながら増やしてOKもらいました", "2025-12-19 19:00"),
    (24, None, "夕食の時間と夜中の血糖値って関係ありますか？", "2025-12-19 20:00"),
    (25, 24, "遅く食べると翌朝高くなる気がする", "2025-12-19 20:30"),
    (26, 24, "私は20時までに食べるようにしてます", "2025-12-19 21:30"),
    (27, None, "寝る前に軽く運動したら夜中の上昇マシになった", "2025-12-20 19:00"),
    (28, 27, "何してますか？", "2025-12-20 19:30"),
    (29, 28, "軽いストレッチと10分くらいのウォーキング", "2025-12-20 20:30"),
    (30, None, "10年以上付き合ってるけど、夜中の上昇は未だに悩み", "2025-12-21 14:00"),
    (31, 30, "長年の悩みなんですね。私もです", "2025-12-21 15:00"),
    (32, None, "ストレスで夜中の血糖値上がりませんか？", "2025-12-21 19:00"),
    (33, 32, "確かに仕事忙しい時期は高くなる気がする", "2025-12-21 19:30"),
    (34, 32, "コルチゾールの影響ですよね。ストレス管理も大事", "2025-12-21 20:30"),
    (35, None, "睡眠の質と夜中の血糖値って関係ありそう", "2025-12-22 14:00"),
    (36, 35, "睡眠不足だと翌朝高くなるって聞いたことある", "2025-12-22 15:00"),
    (37, 35, "7時間はしっかり寝るようにしてます", "2025-12-22 19:00"),
    (38, None, "年末年始、生活リズム乱れると夜中の血糖値やばそう", "2025-12-23 19:00"),
    (39, 38, "夜更かしすると翌朝確実に高くなる", "2025-12-23 19:30"),
    (40, 38, "規則正しい生活心がけます…無理かも笑", "2025-12-23 20:30"),
    (41, None, "Dexcomのアラートで夜中に起きることある", "2025-12-24 08:00"),
    (42, 41, "アラートの設定どうしてますか？", "2025-12-24 09:00"),
    (43, 42, "高値180、低値70にしてます", "2025-12-24 12:00"),
    (44, None, "夜中にトイレで起きると血糖値高いことが多い", "2025-12-25 07:30"),
    (45, 44, "高血糖だと喉乾くからトイレ近くなりますよね", "2025-12-25 08:30"),
    (46, None, "診断されて2年目、夜中の上昇のパターンがやっとわかってきた", "2025-12-26 19:00"),
    (47, 46, "傾向がわかると対策しやすいですよね", "2025-12-26 19:30"),
    (48, None, "お正月、夜更かしで夜中の血糖値乱れそう", "2025-12-28 19:00"),
    (49, 48, "紅白見ながら気をつけましょう笑", "2025-12-28 20:00"),
    (50, None, "あけおめ！昨夜は夜更かししたから今朝の血糖値高かった", "2026-01-01 09:00"),
    (51, 50, "あけおめ！私も150超えてた…", "2026-01-01 10:00"),
    (52, None, "正月明けて生活リズム戻したら夜中の血糖値も安定してきた", "2026-01-04 19:00"),
    (53, 52, "やっぱり規則正しい生活大事ですね", "2026-01-04 19:30"),
    (54, None, "このスレで暁現象のこと詳しく知れた", "2026-01-05 19:00"),
    (55, 54, "情報交換ありがたいですよね", "2026-01-05 19:30"),
    (56, None, "夜中の血糖値、地道に記録して傾向つかんでいきます", "2026-01-06 19:00"),
    (57, 56, "一緒に頑張りましょう！", "2026-01-06 19:30"),
    (58, None, "また夜中の対策で効果あったこと共有してください", "2026-01-07 19:00"),
    (59, 58, "新しい発見あったら書き込みますね", "2026-01-07 19:30"),
    (60, None, "夜中の血糖値コントロール、難しいけど諦めずにやっていく", "2026-01-07 20:30"),
    (61, 60, "お互い頑張りましょう！", "2026-01-07 21:00"),
]
...
def main():
    print(f"Processing {len(COMMENTS)} comments for thread No.26\nThread ID: {THREAD_ID}\n")
