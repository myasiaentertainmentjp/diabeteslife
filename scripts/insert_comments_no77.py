#!/usr/bin/env python3
"""Insert 57 comments for thread No.77: 冬の入浴と血糖値"""
...
THREAD_ID = "b5e09229-3b0d-4805-a3a6-32d54d9606a6"
...
COMMENTS = [
    (2, None, "冬のお風呂は熱めが好きだけど血糖値に影響あるのかな", "2025-12-20 19:45"),
    (3, None, "長風呂すると低血糖になりそうで心配", "2025-12-20 20:30"),
    (4, None, "診断されたばかりで入浴時間とか気にするようになった", "2025-12-20 21:15"),
    (5, 4, "最初は何でも気になりますよね", "2025-12-20 22:00"),
    (6, None, "10年以上この病気だけど、入浴前に血糖値測るようにしてる", "2025-12-21 10:30"),
    (7, 6, "それ大事ですよね。低いときは入浴控えたほうがいい", "2025-12-21 11:15"),
    (8, None, "お風呂で低血糖になったことある人いますか", "2025-12-21 15:45"),
    (9, 8, "一度だけある。めまいがして怖かった", "2025-12-21 16:30"),
    (10, 8, "脱衣所にブドウ糖置いてます", "2025-12-21 17:15"),
    (11, None, "3年目だけどお風呂上がりに血糖値測ると下がってることが多い", "2025-12-21 19:30"),
    (12, 11, "血行良くなるからですかね", "2025-12-21 20:15"),
    (13, None, "熱いお風呂って血圧にも良くないんだよね", "2025-12-22 11:30"),
    (14, 13, "ぬるめがいいとは分かってるけど寒い", "2025-12-22 12:15"),
    (15, None, "食後すぐの入浴は避けたほうがいいらしい", "2025-12-22 18:45"),
    (16, 15, "消化に悪いって聞いたことある", "2025-12-22 19:30"),
    (17, None, "入浴剤使ってる人いますか", "2025-12-23 10:30"),
    (18, 17, "バスクリン愛用してます。香りで癒される", "2025-12-23 11:15"),
    (19, 17, "エプソムソルト使ってます。マグネシウムがいいらしい", "2025-12-23 12:00"),
    (20, None, "半身浴のほうが体に優しいのかな", "2025-12-23 15:45"),
    (21, 20, "心臓への負担は少ないみたいですね", "2025-12-23 16:30"),
    (22, None, "冬は脱衣所が寒くてヒートショックが怖い", "2025-12-23 20:15"),
    (23, 22, "脱衣所に小型ヒーター置いてます", "2025-12-23 21:00"),
    (24, 22, "浴室暖房があると安心", "2025-12-23 21:45"),
    (25, None, "お風呂の時間帯っていつがいいんだろう", "2025-12-24 11:30"),
    (26, 25, "食後2時間くらい空けてからがいいって言われた", "2025-12-24 12:15"),
    (27, None, "寝る前にお風呂入ると眠れる", "2025-12-24 19:20"),
    (28, 27, "体温下がるタイミングで眠くなるらしいですね", "2025-12-24 20:00"),
    (29, None, "シャワーだけで済ませる日も多い", "2025-12-25 14:30"),
    (30, 29, "冬は湯船に浸かりたくなる", "2025-12-25 15:15"),
    (31, None, "入浴中にスマホ見てたら長風呂になっちゃう", "2025-12-25 20:30"),
    (32, 31, "タイマーかけておくといいですよ", "2025-12-25 21:15"),
    (33, None, "お風呂上がりの水分補給大事", "2025-12-26 11:45"),
    (34, 33, "脱水になりますよね", "2025-12-26 12:30"),
    (35, None, "リブレつけてるとお風呂入れる？", "2025-12-26 19:20"),
    (36, 35, "入れますよ。防水だから大丈夫", "2025-12-26 20:00"),
    (37, 35, "私も毎日お風呂入ってるけど問題ない", "2025-12-26 20:45"),
    (38, None, "温泉行きたいけど人前で血糖測定器見られるの恥ずかしい", "2025-12-27 10:30"),
    (39, 38, "リブレなら目立たないですよ", "2025-12-27 11:15"),
    (40, None, "年末年始は銭湯に行く予定", "2025-12-27 18:45"),
    (41, None, "大晦日は長風呂してリラックスしたい", "2025-12-31 19:30"),
    (42, None, "正月はゆっくりお風呂入れる", "2026-01-02 14:15"),
    (43, None, "入浴でリフレッシュ大事", "2026-01-03 18:30"),
    (44, None, "このスレ参考になった", "2026-01-04 19:15"),
    (45, None, "入浴前の血糖チェック、習慣にしよう", "2026-01-05 15:45"),
    (46, None, "ヒートショック対策も大事", "2026-01-05 20:00"),
    (47, None, "冬のお風呂、気をつけることが多い", "2026-01-06 18:30"),
    (48, 47, "でも楽しみたいですよね", "2026-01-06 19:15"),
    (49, None, "安全に入浴を楽しもう", "2026-01-07 20:00"),
    (50, None, "みんなの情報助かる", "2026-01-08 18:45"),
    (51, None, "このスレまた見に来ます", "2026-01-08 21:00"),
    (52, None, "入浴と血糖値の関係、勉強になった", "2026-01-09 19:15"),
    (53, None, "来年の冬も参考にする", "2026-01-09 20:30"),
    (54, None, "冬のお風呂問題、みんなで共有できてよかった", "2026-01-10 18:30"),
    (55, None, "健康に気をつけながらお風呂楽しもう", "2026-01-10 20:15"),
    (56, None, "ありがとうございました", "2026-01-10 21:30"),
    (57, None, "また来年！", "2026-01-11 19:00"),
    (58, None, "お風呂は最高のリラックスタイム", "2026-01-11 20:30"),
]
...
def main():
    print(f"Processing {len(COMMENTS)} comments for thread No.77")
