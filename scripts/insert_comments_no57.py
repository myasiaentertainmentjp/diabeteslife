#!/usr/bin/env python3
"""Insert 42 comments for thread No.57: 親に糖尿病のこと伝える？"""
...
THREAD_ID = "9655f8b2-f329-41ff-90a1-b83069f87ea2"
...
COMMENTS = [
    (2, None, "診断されて半年、まだ親に言えてない。心配かけたくなくて", "2025-12-20 20:15"),
    (3, None, "私も言ってないです。実家遠いし会う機会も少ないから", "2025-12-20 21:30"),
    (4, None, "一人暮らしだと言わなくてもバレないんだよね", "2025-12-21 12:45"),
    (5, None, "言ったら泣かれそうで怖い", "2025-12-21 18:30"),
    (6, 2, "私も最初そう思ってたけど、帰省のとき食事で困って結局言いました", "2025-12-21 19:20"),
    (7, None, "10年以上隠してたけど、去年ついにバレた。薬見られて", "2025-12-21 20:40"),
    (8, 7, "10年は長い…バレたときどんな反応でした？", "2025-12-21 21:15"),
    (9, 8, "最初は「なんで言わなかったの」って怒られた。でもその後は理解してくれた", "2025-12-21 22:00"),
    (10, None, "親も糖尿病だから言いやすかった。遺伝だねって", "2025-12-22 09:30"),
    (11, None, "うちは父が糖尿病で合併症出てるから、自分もなったって言いづらい…", "2025-12-22 12:20"),
    (12, None, "3年目でやっと言えた。案外あっさり受け入れてくれた", "2025-12-22 19:45"),
    (13, 12, "3年も隠してたんですね。言うタイミング難しいですよね", "2025-12-22 20:30"),
    (14, None, "母に言ったら「私の料理が悪かったの？」って自分を責め始めて困った", "2025-12-23 10:15"),
    (15, 14, "あー親世代そういう反応しがちですよね", "2025-12-23 11:00"),
    (16, None, "言ったら「甘いもの食べすぎたからでしょ」って言われてムカついた", "2025-12-23 14:20"),
    (17, None, "診断されたばかりで年末帰省するんだけど、このタイミングで言うべきか悩む", "2025-12-23 19:50"),
    (18, 17, "年末は忙しいし、落ち着いてからでもいいのでは", "2025-12-23 20:25"),
    (19, 17, "逆に帰省中に食事の説明しやすいから言うチャンスかも", "2025-12-23 21:10"),
    (20, None, "結婚してるから義両親にも言うべきか迷う", "2025-12-24 13:30"),
    (21, None, "実親には言ったけど義両親には言ってない。言う必要ある？", "2025-12-24 18:45"),
    (22, 21, "私は言ってないです。食事のときだけ気をつけてる", "2025-12-24 19:30"),
    (23, None, "兄弟には言った？私は弟にだけ言ってある", "2025-12-25 11:20"),
    (24, None, "姉に言ったら「私も気をつけなきゃ」って健康意識高まったみたい", "2025-12-25 15:40"),
    (25, None, "高齢の親に心配かけたくないって気持ちわかる", "2025-12-26 20:10"),
    (26, 25, "うちも80代だから言えない。もう十分心配事あるだろうし", "2025-12-26 21:00"),
    (27, None, "親に言ったら毎日LINEで「血糖値どう？」って来るようになった", "2025-12-27 12:30"),
    (28, 27, "心配してくれてるんだろうけど、それはそれでしんどいですね笑", "2025-12-27 13:15"),
    (29, None, "言わないメリットもあるよね。過干渉されないし", "2025-12-27 19:45"),
    (30, None, "母に伝えたらネットで色々調べて「これ食べちゃダメ」「あれもダメ」って…", "2025-12-28 14:20"),
    (31, 30, "善意なのはわかるけど、間違った情報も多いから困りますよね", "2025-12-28 15:00"),
    (32, None, "5年くらい経ってから言った。コントロールできてるって証明してから", "2025-12-29 10:30"),
    (33, 32, "それいいですね。どう伝えました？", "2025-12-29 11:20"),
    (34, 33, "「実は糖尿病なんだけど、ちゃんと管理できてるから心配しないで」って", "2025-12-29 12:05"),
    (35, None, "伝えるとき「糖尿病」って言葉使わないで「血糖値が高め」って言った", "2025-12-29 20:30"),
    (36, None, "言い方って大事だよね。糖尿病ってワードが重すぎる", "2025-12-30 11:45"),
    (37, None, "このスレ読んでたら言う勇気出てきた。年明けに言ってみようかな", "2025-12-31 19:20"),
    (38, 37, "応援してます！無理しないでね", "2025-12-31 20:00"),
    (39, None, "結局帰省中に言えなかった…また次の機会に", "2026-01-03 18:30"),
    (40, None, "言う言わないは本人の自由だと思う。正解はない", "2026-01-04 12:15"),
    (41, None, "いつか言わなきゃとは思いつつ、タイミング逃し続けてる", "2026-01-05 19:40"),
    (42, None, "親子関係によるよね。うちは元々なんでも話す家庭だったからすぐ言えた", "2026-01-05 21:30"),
    (43, None, "このスレ見て勇気もらった人多そう", "2026-01-05 22:45"),
]
...
def main():
    print(f"Processing {len(COMMENTS)} comments for thread No.57")
